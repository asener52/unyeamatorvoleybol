...
function MemberDropdown({ member, onLogout }) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {member ? (
              <MemberDropdown member={member} onLogout={handleLogout} />
            ) : (
              <Link to="/uye-giris"
        ...
        <div className="lg:hidden bg-primary-900 pb-3 px-4 space-y-1">
          ...
          {member ? (
            <>
              ...
              <Link to="/mesajlar" onClick={() => setOpen(false)} className="flex items-center gap-2 px-3 py-2 text-sm text-blue-100 hover:bg-primary-700 rounded-md">
                <FaComments size={12} /> Mesajlar
              </Link>
